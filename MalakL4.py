    ...
    def attack():
        ...
        while True:
            try:
                ...
                attack_num += 1
                print("[💢]  \033[0;36mMalak-313 \033[0;31m▒\033[1;37m▒ \033[1;33mGET \033[1;37mattack \033[1;34m=> \033[1;35m▒ \033[0m"+ str(attack_num))
            except socket.error:
                print("[💥]\033[1;35m Succesfuly \033[0;31m Check ip in check host \033[0m")
                break
                s.close()
...
'''
    ...
    print((80))
    print(Fore.YELLOW + Style.BRIGHT + "[BIRRUH BIDDAM NAFDHIKA YA AQSA 🇵🇸 LONG LIVE THE STRUGGLE]")
...
def menu():
   # print(Style.BRIGHT + Fore.YELLOW + "[INFO!]" Fore.WHITE + "Press CTRL + C and press enter to exit!!")
    ...
    print(Fore.CYAN + Style.BRIGHT +  "1. DDOS layer 4.  [1]")
